...
$(window).scroll(function(){
    ...
    $('.brand-path').toggleClass('scrolled-brand', $(this).scrollTop() > 50);
    $('.nav-links-hide').toggleClass('scrolled-links', $(window).scrollTop() > 50);
    $('.hamburger-inner').toggleClass('scrolled-burger-inner', $(window).scrollTop() > 50);
});
...
function enableScroll() {
    ...
    if (check === true){
        if(isSafari){
        	...
        	$('.brand-anchor').removeClass('brand-scrolled', $(window).scrollTop() > 50);
        	...
        	$('.burger-link').removeClass('burger-scrolled', $(window).scrollTop() > 50);
        	$('.burger div').removeClass('burger-link-scrolled', $(window).scrollTop() > 50);
            scrollallow = true;
        } else {
